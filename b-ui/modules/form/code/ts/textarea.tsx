...
export /*bundle*/ function BeyondTextarea(props: props): JSX.Element {
	...
	let cls: string = props.className ? `${props.className} beyond-element-textarea` : 'beyond-element-textarea';
	...
	return (
		<div className={cls}>
			<>
				<textarea ref={input} {...properties} name={props.name} onChange={handleChange} value={typeof props.value !== 'undefined' ? props.value : state.value} placeholder={props.placeholder ?? ' '} />
				{props.children}
				{error}
