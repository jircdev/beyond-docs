...
export function IconLogo() {
    return (
        <figure className="animation__bg">
            <div className="beyond__icon hidden-mobile">
                ...
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <g id="beyond-ales" transform="translate(0 58.014)">
                        <path className="st0" d="M8.2-38.4c-0.5,2.1-0.8,4-0.7,5.1C7.6-32.1,8-32,8.7-32.9c0.6-1,1.1-2.2,1.5-3.4C9.4-36.9,8.8-37.6,8.2-38.4z
			...
			c-0.7,3-1.2,5.8-1.3,7.3c-0.1,1.7,0.4,1.8,1.2,0.3c0.7-1.4,1.6-4,2.6-7C14.1-34.4,13.2-34.7,12.4-35L12.4-35z"/>
                    ...
                    <g id="beyond-circle">
                        <path className="st1" d="M16.4,5.9c-0.2,0-0.4,0-0.6,0c-4.5,0.2-8,4-7.8,8.5s4,8,8.5,7.8c4.5-0.2,8-4,7.8-8.5
