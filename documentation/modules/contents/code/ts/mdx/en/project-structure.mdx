...
BeyondJS has a configurable architecture that allows for flexible project structures. However, when creating a project through the Dashboard or ´beyond-first-project´, the initial structure is created as follows:
