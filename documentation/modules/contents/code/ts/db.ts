...
import { TutorialIntro, TutorialBridge, TutorialBackend, TutorialFirstModule, TutorialRouting } from '@beyond/docs/docs/starting/tutorial.code';
import { DashboardPage } from '@beyond/docs/docs/starting/dashboard.code';

/*basic*/
//projects
import { ProjectsIntro, ProjectJson, ProjectCreate, ProjectImports, ProjectStructure, ProjectDependencies } from '@beyond/docs/docs/basic/projects.code';
...
//widgets
import { WidgetsDefinition, WidgetLayout, WidgetPage, Widgets, WidgetController } from '@beyond/docs/docs/basic/widgets/intro.code';
...
//styles
import { StylesImportsPage, StylesModulesPage, StylesTemplatePage, StylesThemePage } from '@beyond/docs/docs/basic/styles.code';
