    ...
    return (
        <>
            ...
            <ul className="list__elements-doc">
                ...
                <li>
                    <ObjectProperty type="EOC" href="/glossary#eoc">template</ObjectProperty>

                    Espacio para explicar de forma resumida cuales son las características del proyecto.
                </li>
                <li>
                    <ObjectProperty type="EOC" href="/glossary#eoc">layout</ObjectProperty>

                    Espacio para explicar de forma resumida cuales son las características del proyecto.
                </li>
                <li>
                    <ObjectProperty type="EOC" href="/glossary#eoc">params</ObjectProperty>
                ...
                <li>
                    <ObjectProperty type="EOC" href="/glossary#eoc">modules</ObjectProperty>
                ...
                <li>
                    <ObjectProperty type="EOC" href="/glossary#eoc">deployment</ObjectProperty>
