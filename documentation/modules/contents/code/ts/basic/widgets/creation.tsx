...
export function WidgetCreation() {
    return (
        <>
            ...
            <p>
                Todos los bundles pueden crearse desde el formulario de creación de módulos en el <Link
                href="/docs/dashboard">Dashboard</Link> y de este modo, <BeyondName/> se encarga de generar la
