    ...
    return (
        <div className="content">
            ...
            <p>
                ...
                en realtime para dejar disponible en mejoria una nueva versión de los bundles, realizando los cambios de
                ...
                un servicio en simismo. Beyond detecta los cambios hechos en un archivo o modulo interno, actualiza el
