...
export function ProjectJson() {
    return (
        <>
            ...
            <p>
                Un proyecto o biblioteca (proyecto hecho en beyond que es importado por otro)<span
                className="beyond">BeyondJS</span>,
                representa un paquete de funcionalidades disponible para utilizar en los entornos definidos en el mismo,
                estos entornos pueden ser Node, web, desktop o móvil.

            </p>
            <ModalImage src="/contents/static/projects-list.png" alt="Beyond's project list view"/>
            <p>
                Los proyectos<span className="beyond">BeyondJS</span>siguen la especificación <strong>npm</strong> y
                pueden ser publicados como paquetes de forma simple.
            </p>
            <div className="block__note">
                ...
                un proyecto de forma manual, debe hacerse por meido del archivo <code
                className="inline-code">beyond.json</code>, que permite, entre otras cosas,
                especificar los proyectos que deben ser levantados por el framwork.
            </div>
