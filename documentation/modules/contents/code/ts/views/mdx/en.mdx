...
After executing the command, a message will appear indicating that the dashboard is available at <ELink to="https://workspace.beyondjs.com/">https://workspace.beyondjs.com/</ELink> While navigating it, you will be able to see the Dashboard interface with the project list board, where the created project appears with the link to navigate it below the title. If we click on it, the screen will split into two, and we will be able to navigate the project from the dashboard.
