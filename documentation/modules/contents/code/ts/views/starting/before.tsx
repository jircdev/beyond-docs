...
export function Before() {
    return (
        <>
            <h2 id="before">Antes de empezar</h2>
            <p>
            ...
            <p>
                Es ideal lo completes para que veas como en poco tiempo logras integrar back y front utilizando la misma
                estructura, utilizando javascript de forma universal.
            </p>
