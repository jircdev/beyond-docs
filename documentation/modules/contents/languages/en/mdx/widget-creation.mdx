...
<Subtitle>Creation with the workspace</Subtitle>

// Img

All bundles can be created from the module creation form in the <Link to="/docs/workspace">workspace</Link> By doing this, BeyondJS takes care of generating the necessary files and folder structure, including the Controller definition and the module.json and .tsconfig files.

When bundles are created through the workspace, the files will be generated and modified by the development service.
