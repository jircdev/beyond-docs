...
The transversal bundles, are defined the same as the other bundles, but have a particularity that offers
productive advantages: the code of a traversal bundle is compiled into a single file.
