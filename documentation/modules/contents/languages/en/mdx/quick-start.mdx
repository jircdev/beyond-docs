...
Done! Now you can start programming and testing the project. The workspace is accessed through: <ELink to="https://workspace.beyondjs.com/">https://workspace.beyondjs.com/</ELink> and the project created is available at <ELink to="http://localhost:6500">http://localhost:6500</ELink>

The workspace is a system that BeyondJS provides the developer with a better user experience. You can read more about him <Link to="/docs/workspace">here.</Link>
...
If everything goes smothly, a message will appear saying that BeyondJS is running and that you can access the workspace at <ELink to="https://workspace.beyondjs.com/">https://workspace.beyondjs.com/</ELink>, from where a project is created through the workspace graphical.

Also at the workspace, you can create a project from the graphical interface. See how you can do it <Link to="/docs/projects/create">here.</Link>
