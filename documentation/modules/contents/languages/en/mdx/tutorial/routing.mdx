...
Now, we will go to the module and add a simple message that says "Welcome!" with the style we want.

<Title tag="h2" text="Navegación" />

Get ready to make a big leap in your application by redirecting to your welcome module after login.
...
With these simple steps, you will be redirecting your users to the welcome page.
