...
<div className="block__note">
    BeyondJS provides a routing object to interact with the navigation api, you can learn more about it in the section
    on <Link to="/docs/routing">Routing page.</Link>
</div>
