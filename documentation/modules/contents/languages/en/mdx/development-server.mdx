...
<ELink to="https://nodejs.org/api/esm.html#https-and-http-imports">https://nodejs.org/api/esm.html#https-and-http-imports</ELink>
...
The `beyond.json` file can be edited manually or through the workspace which is available by default at <ELink to="https://workspace.beyondjs.com/">https://workspace.beyondjs.com/</ELink>
...
-   applications <Link to="/aoc">AOC:</Link> Receive an array with the list of projects or applications configured so that BeyondJS can read and launch them. This file is managed by BeyondJS if the workspace is being used.
