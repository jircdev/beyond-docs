import { DocHeader, BeyondJS, ELink, NextLinks, Subtitle, Link } from '@beyond/docs/components/html';
import { Code, CodeBox } from '@beyond/docs/code';

<DocHeader pretitle="Tutorial" title="Código Bridge" />
Como mencionamos antes, en esta parte generalmente cada proyecto tiene su propia lógica para la validación de sesión. La
...
El comentario mágico /_bundle_/es utilizado por Beyond para identificar que
...
El comentario mágico /_actions_/es utilizado por Beyond para identificar
...
Beyond Environment Execution - Workspace - BeyondJs
...
-   <Link href="/docs/tutorial/routing">Enrutamiento</Link>
