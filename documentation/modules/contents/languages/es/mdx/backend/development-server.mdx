...
Si deseas aprender más sobre la configuración de distribuciones, puedes leerlo en <Link href="/docs/projects/distributions">La Sección de Distribuciones.</Link>
...
-   applications <Link href="/aoc">AOC:</Link> Recibe un arreglo con la lista de proyectos o aplicaciones configuradas para que BeyondJS pueda leerlas y levantarlas. Este archivo, es gestionado por BeyondJS si se hace uso del workspace.
-   bundles object: Permite configurar la inclusión de bundles creados por el programador.
-   libraries <Link href="/aoc">AOC:</Link> Arreglo de configuración de librerias BeyondJS a utilizar.
