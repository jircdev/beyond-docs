...
Escucha los cambios desde el Inspector de BeyondJS y realiza carga inmediata mediante HMR de los elementos modificados.
...
Habilita el comportamiento HMR en los proyectos realizados con <BeyondJS/>. Es una dependencia necesaria para el entorno de desarrollo.

<Title tag="h3" text="@beyond-js/ssr" />

BeyondJS implementa Server Side Rendering (SSR) mediante un servidor HTTP con tres endpoints: widget y page. Permite implementar
soluciones de SSR en proyectos web. Puedes leer más acerca de las buenas prácticas y otras formas de renderizado
en <Link href="/docs/widgets/rendering"> la sección de Renderizado con Widgets</Link>
...
Además, <BeyondJS/> ofrece los siguientes paquetes específicos para crear proyectos Web con Renderizado cliente, estático o de servidor (SSR)
utilizando <ELink hef="https://reactjs.org/">React</ELink>, <ELink href="https://vuejs.org/">Vue</ELink> y <ELink href="https://svelte.dev/">Svelte</ELink>.
