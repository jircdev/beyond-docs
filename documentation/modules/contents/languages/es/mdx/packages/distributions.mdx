...
-   <ItemProperty type="string" optional label="backend">
    	Esta propiedad se utiliza cuando el paquete es un proyecto que se conecta con un servicio node de tipo backend.
    	Puedes leer más acerca de esto en la <Link href="/bridges">sección de Bridges</Link> .
    </ItemProperty>
