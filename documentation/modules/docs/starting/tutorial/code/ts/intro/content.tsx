...
import {BeyondName, Render, Loading} from "@beyond/docs/components/html/code";
...
<section>
    ...
    <Code language="shell">
        {`> npx @beyond-js/create-project --name @testing/login --type web-backend --container beyond`}
    </Code>
